...
-- Define layout icons
theme.layout_tile = "~/.config/awesome/theme/icons/layouts/tiled.png"
theme.layout_floating = "~/.config/awesome/theme/icons/layouts/floating.png"
theme.layout_max = "~/.config/awesome/theme/icons/layouts/maximized.png"
...
local icon_dir = gears.filesystem.get_configuration_dir() .. "theme/icons/titlebar/"

theme.titlebar_bg_focus = theme.bg_blurry
theme.titlebar_bg_normal = theme.bg_blurry
