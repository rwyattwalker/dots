# Generated by Powerlevel10k configuration wizard on 2022-10-23 at 15:00 CDT.
...
# blurred heads, flat tails, 1 line, sparse, many icons, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=175
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local conflicted='%176F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%243F'  # grey foreground
      local      clean='%243F'  # grey foreground
      local   modified='%243F'  # grey foreground
      local  untracked='%243F'  # grey foreground
      local conflicted='%243F'  # grey foreground
    fi
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=208
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=109
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='${P9K_IP_RX_RATE:+%72F⇣$P9K_IP_RX_RATE }${P9K_IP_TX_RATE:+%215F⇡$P9K_IP_TX_RATE }%109F$P9K_IP_IP'
